...
public class SoundPlayer implements Runnable
{
	...
	private void createPlayer() throws Exception
	{
		...
		if (mediaURL != null)
		{
			...
			AudioManager mAudioManager = (AudioManager) Main.ctx.getSystemService(Main.ctx.AUDIO_SERVICE); 
			mAudioManager.setStreamVolume(AudioManager.STREAM_SYSTEM, 100, 0); 
