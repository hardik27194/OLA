...
ImageView
{
	...
	public RoundImage(Context context, AttributeSet attrs, int
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius)
	{
		...
		int mixLenth=Math.min(bmpWidth, bmpHeight);
		float scale=diameter*1.0f/mixLenth;
		scaledSrcBmp = Bitmap.createScaledBitmap(bmp, (int)(bmpWidth*scale),
					(int)(bmpHeight*scale), true);

		bmpHeight=scaledSrcBmp.getHeight();
		bmpWidth=scaledSrcBmp.getWidth();
		...
		{// 高大于宽
			...
			squareBitmap = Bitmap.createBitmap(scaledSrcBmp, x, y, squareWidth,
					squareHeight);
	...
	public Bitmap getCroppedRoundBitmap1(Bitmap bmp, int radius)
	{
		...
		(squareBitmap.getWidth() != diameter
